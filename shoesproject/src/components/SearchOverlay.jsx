...
export const SearchOverlay = () => {
  ...
  // Логика фильтрации обуви и сумок по введенному запросу
  useEffect(() => {
    if (query.trim()) {
      ...
      const filteredGallery = gallery
        ...
        .map(item => ({ ...item, itemType: 'gallery' }));

     
      setResults([...filteredProducts, ...filteredGallery]);
    } else {
      setResults([]);
    }
  }, [query]);
              ...
              <div className="bg-white rounded-3xl shadow-2xl overflow-hidden">
                ...
                <div className="flex items-center gap-4 p-4 border-b">
                  ...
                  <input 
                    ...
                    placeholder="Ayaqqabı və ya çanta axtar..." 
                  ...
                  {results.length > 0 ? (
                        ...
                        >
                          ...
                          <div className="flex-1">
                            <div className="flex items-center gap-2">
                              ...
                              <span className="text-[10px] uppercase px-2 py-0.5 bg-gray-100 text-gray-500 rounded-full">
                                {item.itemType === 'gallery' ? 'Çanta' : 'Ayaqqabı'}
                              </span>
                            </div>
                    ...
                    <div className="p-6">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {['Dabanlıq', 'Dəri çanta', 'Səndəl', 'Ryukzak', 'Krossovka'].map(term => (
                          <button 
                            key={term} 
